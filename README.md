SwiftLibgd is a Swift wrapper for [libgd](https://github.com/libgd/libgd), providing server-side image manipulation where Core Graphics isn’t available. Built for Swift 6.2+.
